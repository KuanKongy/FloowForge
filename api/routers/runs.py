...
def _collect_run_source_inputs(nodes: list[dict[str, object]], edges: list[dict[str, object]]) -> dict[str, list[str]]:
...
def _ordered_run_source_ids(records: list[dict[str, object]]) -> list[str]:
