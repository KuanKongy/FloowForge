...
def _collect_llm_session_inputs(nodes: list[dict[str, object]], edges: list[dict[str, object]]) -> dict[str, list[str]]:
...
def _ordered_llm_session_ids(records: list[dict[str, object]]) -> list[str]:
